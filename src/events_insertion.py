...
if __name__ == '__main__':
    ...
    # biobankdata_insertion('accs_filled', (2500, 6000, 9500, 13000, 16500), 750, 'sudden') # incremental


    # stockdata_insertion('BMW.DE_daily', (1200, 2400, 3600, 4800, 6000), 250, 'sudden')
    # stockdata_insertion('BMW.DE_hourly', (1000, 2000, 3000, 4000, 5000), 200, 'sudden')
    # stockdata_insertion('BMW.DE_minutely', (300, 600, 900, 1200, 1500), 70, 'sudden')
