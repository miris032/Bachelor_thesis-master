...
def draw_plots(file):
    ...
    data = np.asarray(pd.read_csv(f'{root}/ticker_data/columns_hourly/' + f'{file}' + '.csv', delimiter=",", header=None))
    ...
    plt.suptitle(f'{filename}' + '_hourly', fontsize=16, fontweight='bold')
